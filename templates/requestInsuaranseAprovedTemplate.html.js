export const requestInsuranceApprovalTemplate = (message, fileLink) => `
<!DOCTYPE html>
<html lang="ar">
...
<head>
    ...
    <title>تهانينا على قبول ضمان لعميلكم بنجاح!</title>
    <style>
...
<body>
    <table id="email-container">
        ...
        <tr>
            <td>
                <h1>تهانينا على قبول ضمان لعميلكم بنجاح!</h1>
            </td>
        </tr>
        <tr>
            <td>
                <h2 class="blog-title">تم الموافقة بعد مراجعة الطلب</h2>
                <p class="blog-text">
                ${message} 
                </p>
                <div id="read-more">
                    <a href="https://strong-care-front-dev.vercel.app//">اطلع على عقد الضمان الخاص بك الان</a>
                </div>
                <div align="center">
