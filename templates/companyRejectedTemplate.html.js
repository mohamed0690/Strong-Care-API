export const companyRejectedTemplate = (message) => `
<!DOCTYPE html>
<html lang="ar">
...
<body>
    <table id="email-container">
        ...
        <tr>
            <td>
                <h1>تم رفض طلب شركتكم</h1>
            </td>
        </tr>
        <tr>
            <td>
                <h2 class="blog-title">الطلب تم رفضه</h2>
                <p class="blog-text">
                   ${message}
                </p>
                <div id="read-more">
                    <a href="https://strong-care-front-dev.vercel.app//contactus"
